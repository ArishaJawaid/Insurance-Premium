...
df = pd.read_csv('insurance_75000_2.csv',encoding='latin1')
...
#7th
    ...
    ], style={ 'color':'black','text-align': 'center', 'fontSize': 18, 'font-family': 'EB Garamond','backgroundColor': 'transparent'}),
